...
export class SettingService {
  ...
  getByState(state:any){
    return this.http.get<any[]>(`${ConfigService.toApiUrl("settings-by-state")}/${state}`,ConfigService.addAction('LISTER'));
  }
  ...
  setState(id:any,state:any){
    return this.http.get<any[]>(`${ConfigService.toApiUrl("settings-set-state")}/${id}/state/${state}`,ConfigService.addAction('CHANGER_STATUT'));
  }
}
