...
export class ProjectGeneratorComponent {
  ...
  templates = [
    ...
    { id: 'ecommerce-site', title: 'Site E-commerce', category: 'Développement', description: 'Création d\'une plateforme de vente en ligne', duration: '3-5 mois', complexity: 'Moyenne', complexityColor: 'text-yellow-600', icon: 'ri-shopping-cart-line', color: 'bg-primary-500' }
  ];
  ...
  recentProjects = [
    ...
    { id: 2, title: 'Migration Cloud Infrastructure', category: 'Infrastructure', date: '2024-01-12', budget: '75 000€', duration: '4 mois', status: 'En cours', statusColor: 'bg-primary-100 text-primary-800' },
