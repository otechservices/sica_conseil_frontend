...
export class ExpertiseComponent implements OnInit {
  ...
  certifications = [
    { name: 'PMP®', count: 15, color: 'bg-primary-500' }, { name: 'PRINCE2®', count: 12, color: 'bg-purple-500' },
